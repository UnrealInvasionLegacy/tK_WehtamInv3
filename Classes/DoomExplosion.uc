class DoomExplosion extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_WehtamInv3.DoomExplosion.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'tk_WehtamInv3.DoomExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(0)=(Color=(B=55,G=255,R=55))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=55,G=255,R=55))
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_WehtamInv3.DoomExplosion.SpriteEmitter4'
     ...
     End Object
     Emitters(3)=BeamEmitter'tk_WehtamInv3.DoomExplosion.BeamEmitter0'
     ...
     End Object
     Emitters(4)=BeamEmitter'tk_WehtamInv3.DoomExplosion.BeamEmitter1'
     ...
     End Object
     Emitters(5)=BeamEmitter'tk_WehtamInv3.DoomExplosion.BeamEmitter3'
     ...
     End Object
     Emitters(6)=BeamEmitter'tk_WehtamInv3.DoomExplosion.BeamEmitter10'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=55,G=255,R=55))
         ColorScale(1)=(RelativeTime=0.700000,Color=(B=55,G=255,R=55))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.500000
         MaxParticles=1
     ...
     End Object
     Emitters(7)=MeshEmitter'tk_WehtamInv3.DoomExplosion.MeshEmitter0'
