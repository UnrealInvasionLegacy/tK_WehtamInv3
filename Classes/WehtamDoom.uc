class WehtamDoom extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_WehtamInv3.WehtamDoom.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'tk_WehtamInv3.WehtamDoom.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(0)=(Color=(B=55,G=55,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=55,G=55,R=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_WehtamInv3.WehtamDoom.SpriteEmitter4'
     ...
     End Object
     Emitters(3)=BeamEmitter'tk_WehtamInv3.WehtamDoom.BeamEmitter0'
     ...
     End Object
     Emitters(4)=BeamEmitter'tk_WehtamInv3.WehtamDoom.BeamEmitter1'
     ...
     End Object
     Emitters(5)=BeamEmitter'tk_WehtamInv3.WehtamDoom.BeamEmitter3'
     ...
     End Object
     Emitters(6)=BeamEmitter'tk_WehtamInv3.WehtamDoom.BeamEmitter10'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=55,G=55,R=255))
         ColorScale(1)=(RelativeTime=0.700000,Color=(B=55,G=55,R=255))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.500000
         MaxParticles=1
     ...
     End Object
     Emitters(7)=MeshEmitter'tk_WehtamInv3.WehtamDoom.MeshEmitter0'
