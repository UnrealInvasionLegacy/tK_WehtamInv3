class PawnExplosion extends RedeemerExplosion;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=1,R=255,A=190))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=60
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(G=6,R=60,A=100))
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=8,R=80,A=255))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=150
         StartLocationShape=PTLS_Sphere
     ...
     End Object
     Emitters(2)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=5,G=1,R=255))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=5,G=1,R=197))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=7,G=1,R=186))
         ColorScale(3)=(RelativeTime=1.000000)
         ...
         Texture=Texture'EpicParticles.Smoke.FlameWave3'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=1.000000,Max=1.000000)
         InitialDelayRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(4)=MeshEmitter'tk_WehtamInv3.PawnExplosion.MeshEmitter0'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=2,G=2,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=2,G=2,R=255,A=128))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeOutStartTime=1.000000
         FadeInEndTime=0.100000
         MaxParticles=1
     ...
     End Object
     Emitters(5)=MeshEmitter'tk_WehtamInv3.PawnExplosion.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=6,G=1,R=255))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=2,G=1,R=187))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=2
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'tk_WehtamInv3.PawnExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'tk_WehtamInv3.PawnExplosion.MeshEmitter2'
}
